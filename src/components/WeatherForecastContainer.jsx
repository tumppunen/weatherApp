...
const WeatherForecastContainer = (props) => {
    ...
    const weatherData = props.cityChosen !== 'all' ? props.weatherData.filter(data => data.cityId == props.cityChosen) : props.weatherData
    ...
    return (
        <div>
            <div className={classes.weatherForecastContainer}>
                <select className={classes.dropDown} id="cities" name="cities" onChange={(e) => props.setCityChosen(e.target.value)}>
